...
find "$CODESIGNING_FOLDER_PATH/python/lib/lib-dynload" -name "*.so" | while read FULL_EXT; do
    install_dylib python/lib/lib-dynload/ "$FULL_EXT"
done

echo "Install app package extension modules..."
find "$CODESIGNING_FOLDER_PATH/python/site_packages" -name "*.so" | while read FULL_EXT; do
    install_dylib python/site_packages/ "$FULL_EXT"
done
